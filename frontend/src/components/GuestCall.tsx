    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          border: `1px solid ${isConnected ? "rgba(74,222,128,0.3)" : "var(--glass-border)"}`,
      ...
      <div style={{
        ...
        {!isConnected && (
          <div style={{
            ...
            background: "radial-gradient(ellipse at 50% 55%, rgba(123,143,255,0.05) 0%, transparent 70%), var(--bg-base)",
            padding: "1.5rem",
          }}>
            <div style={{
